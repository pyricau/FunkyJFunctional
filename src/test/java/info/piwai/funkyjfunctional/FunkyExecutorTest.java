...
public class FunkyExecutorTest {
    ...
    public void classInstanciated() {
        ...
        // @fon
        ClassExecutor<Instanciated> executor = new FunkyExecutor<Instanciated>(Instanciated.class, (Object) null);
    ...
    public void multipleConstructors() {
        ...
        new FunkyExecutor<Instanciated>(Instanciated.class, (Object) null);
    }
